...
namespace Konamiman.Z80dotNet.Tests
{
    public class Z80ProcessorTests_Interrupts
    {
        ...
        private InterruptSourceForTests InterruptSource1 { get; set; }
        private InterruptSourceForTests InterruptSource2 { get; set; }
        ...
        public void Nmi_is_accepted_after_instruction_execution()
        {
            ...
            var nmiFired = false;
            var serviceRoutineInvoked = false;
            var serviceRoutineReturned = false;
        ...
        public void Int2_calls_to_address_composed_from_I_and_data_bus_and_triggers_memory_events()
        {
            ...
            var serviceRoutineInvoked = false;
            var beforeMemoryReadEventFiredForPointerAddress = false;
            var afterMemoryReadEventFiredForPointerAddress = false;
