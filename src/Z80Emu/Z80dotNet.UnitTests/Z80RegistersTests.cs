...
namespace Konamiman.Z80dotNet.Tests
{
    public class Z80RegistersTests
    {
        ...
        private Z80Registers Sut { get; set; }
        ...
        public void Can_set_Alternate_to_non_null_value()
        {
            ...
            Sut.Alternate = value;
            Assert.That(value, Is.EqualTo(Sut.Alternate));
        }

        [Test]
        public void Cannot_set_Alternate_to_null()
        {
            Assert.Throws<NullReferenceException>(() => Sut.Alternate = null);
        }
        ...
        public void Gets_IXh_and_IXl_correctly_from_IX()
        {
            ...
            Assert.That(IXh, Is.EqualTo(Sut.IXH));
            Assert.That(IXl, Is.EqualTo(Sut.IXL));
        }
        ...
        public void Gets_IYh_and_IYl_correctly_from_IY()
        {
            ...
            Assert.That(IYh, Is.EqualTo(Sut.IYH));
            Assert.That(IYl, Is.EqualTo(Sut.IYL));
        }
        ...
        public void Gets_I_and_R_correctly_from_IR()
        {
            ...
            Assert.That(I, Is.EqualTo(Sut.I));
            Assert.That(R, Is.EqualTo(Sut.R));
        }
