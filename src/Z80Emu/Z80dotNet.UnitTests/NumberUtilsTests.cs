namespace Konamiman.Z80dotNet.Tests
{
    public class NumberUtilsTests
    {
        ...
        [Test]
        public void SetBitShouldWork_ForShorts()
        {
            short value = 0b0000_0000_0000_0000;
            value = value.SetBit(0, 1);
            Assert.That(value, Is.EqualTo(0b0000_0000_0000_0001));
            value = value.SetBit(2, 1);
            Assert.That(value, Is.EqualTo(0b0000_0000_0000_0101));
            value = value.SetBit(0, 0);
            Assert.That(value, Is.EqualTo(0b0000_0000_0000_0100));
            value = value.SetBit(1, 0);
            Assert.That(value, Is.EqualTo(0b0000_0000_0000_0100));
        }
        ...
        {
            byte lsb0 = 0xFE;
            Assert.That(lsb0.GetBit(0) == 0);

            byte lsb1 = 0x01;
            Assert.That(lsb1.GetBit(0) == 1);
        }
        ...
        {
            byte msb0 = 0x7F;
            Assert.That(msb0.GetBit(7) == 0);

            byte msb1 = 0x80;
            Assert.That(msb1.GetBit(7) == 1);
        }
        ...
        public void GetBit_works_for_middle_bit()
        {
            ...
            Assert.That(bit4reset.GetBit(4) == 0);

            byte bit4set = 0x10;
            Assert.That(bit4set.GetBit(4) == 1);
        }
        ...
        public void Between_works_as_expected()
        {
            ...
            Assert.That(value.Between(0x7F, 0xFF));
            Assert.That(value.Between(0x80, 0xFF));
