...
namespace Konamiman.Z80dotNet
{
    ...
    {
        /// <summary>
        /// Gets the <see cref="IZ80ProcessorAgent"/> that the <see cref="Execute"/> method will use in order
        /// to interact with the processor.
        /// </summary>
        IZ80ProcessorAgent ProcessorAgent { get; }

        /// <summary>
        /// Initializes the instruction executor with the specified processor agent.
        /// </summary>
        /// <param name="ProcessorAgent"></param>
        void InitProcessorAgent(IZ80ProcessorAgent ProcessorAgent);
